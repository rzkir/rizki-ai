...
const CONVERSATIONS_KEY = 'health_conversations';
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            try {
                ...
                console.error('Error loading health history from localStorage:', error);
            }
        }
    }, []);
            ...
            if (newUserMessages.length > 0) {
                setHistoryItems(prev => {
                    ...
                    try {
                        ...
                        console.error('Error saving health history to localStorage:', error);
                    }
                    return updated;
                });
