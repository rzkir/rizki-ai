            ...
            if (messages.length === 0 && finalContent) {
                setMessages(prev => {
                    ...
                    if (lastAssistantMessage && lastAssistantMessage.role === 'assistant') {
                        ...
                        const welcomeAddition = '\n\nSaya di sini untuk membantu Anda dengan kesehatan dan kesejahteraan. Saya bisa memberikan saran tentang fitness, nutrisi, kesehatan mental, dan gaya hidup sehat. Ingat, untuk masalah medis serius, selalu konsultasikan dengan profesional kesehatan. Ada yang ingin Anda tanyakan tentang kesehatan hari ini? 💚';
                        ...
                        <div className="max-w-4xl w-full space-y-8 flex flex-col items-center">
                            ...
                            <div className="grid grid-cols-2 gap-3 w-full max-w-2xl">
                                <Card
                                    ...
                                    onClick={() => setInput('Berikan tips untuk menjaga kesehatan mental')}
                                >
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('Bagaimana cara membuat rencana diet sehat?')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                            Rencana Diet Sehat
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('Rekomendasikan latihan olahraga untuk pemula')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('Jelaskan manfaat tidur yang cukup untuk kesehatan')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                            Manfaat Tidur Cukup
            ...
            <div className="border-t border-border bg-background px-6 py-4 sticky bottom-0">
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
                    ...
                    <p className="text-xs text-muted-foreground text-center mt-2">
                        Health AI Assistant provides general wellness information. For serious medical concerns, please consult with a healthcare professional.
                    </p>
                </form>
            </div>
        </div>
