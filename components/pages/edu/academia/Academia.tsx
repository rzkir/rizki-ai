...
import { Send, User, MessageSquare, BookOpen, Brain } from 'lucide-react';
...
import { useStateAcademia } from './lib/useStateAcademia';
...
export default function Chat() {
    ...
    const quickPrompts = [
        { title: 'Metode Penelitian', prompt: 'Jelaskan metode penelitian yang digunakan', icon: Brain },
        { title: 'Review Literatur', prompt: 'Bagaimana cara membuat review literatur?', icon: Brain },
        { title: 'Struktur Paper', prompt: 'Jelaskan struktur paper yang digunakan', icon: Brain },
        { title: 'Analisis Data', prompt: 'Jelaskan analisis data yang digunakan', icon: Brain },
    ];
        ...
        <AsideLayout>
            <Sidebar
                header={{
                    icon: BookOpen,
                    title: 'Academic AI',
                    subtitle: 'Research & study companion',
                }}
                open={sheetOpen}
                                ...
                                {messages.length === 0 ? (
                                    <div className="h-full flex flex-col items-center justify-center text-center space-y-8 py-8">
                                        ...
                                        <div className="space-y-4 max-w-2xl">
                                            <h2 className="text-3xl font-bold tracking-tight text-foreground">Academic AI</h2>
