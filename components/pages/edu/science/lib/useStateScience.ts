...
const STORAGE_KEY = 'science_history';
const CONVERSATIONS_KEY = 'science_conversations';
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            try {
                ...
                console.error('Error loading science history from localStorage:', error);
            }
        }
    }, []);
            ...
            if (newUserMessages.length > 0) {
                setHistoryItems(prev => {
                    ...
                    try {
                        ...
                        console.error('Error saving science history to localStorage:', error);
                    }
                    return updated;
                });
