...
import { Send, User, MessageSquare, Atom, Brain } from 'lucide-react';
...
import { useStateScience } from './lib/useStateScience';
...
export default function Chat() {
    ...
    const quickPrompts = [
        { title: 'Konsep Ilmiah', prompt: 'Jelaskan konsep ilmiah yang digunakan', icon: Brain },
        { title: 'Eksperimen Ilmiah', prompt: 'Bagaimana cara melakukan eksperimen ilmiah?', icon: Brain },
        { title: 'Teori Ilmiah', prompt: 'Jelaskan teori ilmiah yang digunakan', icon: Brain },
        { title: 'Penemuan Ilmiah', prompt: 'Jelaskan penemuan ilmiah yang digunakan', icon: Brain },
    ];
        ...
        <AsideLayout>
            <Sidebar
                header={{
                    icon: Atom,
                    title: 'Science AI',
                    subtitle: 'Explore concepts & experiments',
                }}
                open={sheetOpen}
            ...
            <AsideInset>
                                ...
                                {messages.length === 0 ? (
                                    <div className="h-full flex flex-col items-center justify-center text-center space-y-8 py-8">
                                        <div className="w-16 h-16 items-center justify-center rounded-2xl bg-primary/10 hidden md:flex">
                                            <Atom className="w-10 h-10 text-primary" strokeWidth={1.5} />
                                        </div>
                                        <div className="space-y-4 max-w-2xl">
                                            <h2 className="text-3xl font-bold tracking-tight text-foreground">Science AI</h2>
                                            <p className="text-base text-muted-foreground">
                                                Explore scientific concepts, experiments, theories, and discoveries across all fields of science.
                                            </p>
                                        </div>
                ...
                <InputArea
                    ...
                    placeholder="Ask about science, experiments, or scientific concepts..."
                    isLoading={isLoading}
                    submitIcon={Send}
