...
export default function Chat() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await streamChat({
                endpoint: API_ENDPOINTS.finance,
                        ...
                        <div className="max-w-4xl w-full space-y-8 flex flex-col items-center">
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <p className="text-lg text-muted-foreground">
                                    Get expert guidance on personal finance, investments, budgeting, and financial planning
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 w-full max-w-2xl">
                                <Card
                                    ...
                                    onClick={() => setInput('Bagaimana cara membuat anggaran keuangan pribadi?')}
                                >
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('Jelaskan strategi investasi untuk pemula')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('Apa perbedaan antara saham dan obligasi?')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                            Saham vs Obligasi
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('Tips mengelola utang dengan baik')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                            Manajemen Utang
                            ...
                            <div className="bg-transparent rounded-lg p-4 max-w-2xl mx-auto flex items-start gap-3">
                                ...
                                <div className="flex flex-col">
                                    <p className="text-foreground/90 text-sm leading-relaxed">
                                        Hello! I&apos;m your finance AI assistant.
                                    </p>
                                    <p className="text-foreground/70 text-sm leading-relaxed mt-1">
                                        I specialize in personal finance, investments, budgeting, financial planning, and money management. Note: I provide information for educational purposes, not formal financial advice.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="border-t border-border bg-background px-6 py-4 sticky bottom-0">
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
                    ...
                    <p className="text-xs text-muted-foreground text-center mt-2">
                        Finance AI Assistant provides information for educational purposes only. Consult a qualified financial advisor for personalized financial advice.
                    </p>
                </form>
            </div>
        </div>
