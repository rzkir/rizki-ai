...
export function useStateFinance() {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            try {
                ...
                console.error('Error loading finance history from localStorage:', error);
            }
        }
    }, []);
            ...
            if (newUserMessages.length > 0) {
                setHistoryItems(prev => {
                    ...
                    try {
                        ...
                        console.error('Error saving finance history to localStorage:', error);
                    }
                    return updated;
                });
