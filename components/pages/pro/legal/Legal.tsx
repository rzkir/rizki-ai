...
import { Send, User, MessageSquare, Scale } from 'lucide-react';
...
import { useStateLegal } from './lib/useStateLegal';
...
export default function Chat() {
    ...
    const quickPrompts = [
        { title: 'Contract Law Basics', prompt: 'Explain the basics of contract law', icon: Scale },
        { title: 'IP Protection', prompt: 'How to protect intellectual property', icon: Scale },
        { title: 'Employment Law', prompt: 'What are the key employment law requirements', icon: Scale },
        { title: 'Regulatory Compliance', prompt: 'How to ensure regulatory compliance', icon: Scale },
    ];
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <p className="text-lg text-muted-foreground max-w-2xl">
                                                    Get legal guidance, compliance, contract, and regulatory information.
                                                </p>
                                            </div>

                                            <div className="space-y-4">
                                                <AsideSectionDivider>Suggested Legal Actions</AsideSectionDivider>
