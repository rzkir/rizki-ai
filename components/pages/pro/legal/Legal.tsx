                        ...
                        <div className="max-w-4xl w-full space-y-8 flex flex-col items-center">
                            ...
                            <div className="grid grid-cols-2 gap-3 w-full max-w-2xl">
                                <Card
                                    ...
                                    onClick={() => setInput('Explain the basics of contract law')}
                                >
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('How to protect intellectual property')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                            IP Protection
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('What are the key employment law requirements')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                                            Employment Law
                                ...
                                <Card
                                    className="cursor-pointer hover:border-primary/50 transition-all hover:bg-muted/50 py-4"
                                    onClick={() => setInput('How to ensure regulatory compliance')}
                                >
                                    <CardContent className="p-0 px-4">
                                        <p className="text-sm font-medium text-foreground leading-relaxed">
                            ...
                            <div className="bg-transparent rounded-lg p-4 max-w-2xl mx-auto flex items-start gap-3">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-foreground/70 text-sm leading-relaxed mt-1">
                                        I specialize in legal guidance, compliance, contracts, regulations, and legal procedures. Note: I provide information, not legal advice.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="border-t border-border bg-background px-6 py-4 sticky bottom-0">
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
                    ...
                    <p className="text-xs text-muted-foreground text-center mt-2">
                        Legal AI Assistant provides information only. Consult a qualified attorney for legal advice.
                    </p>
                </form>
            </div>
        </div>
