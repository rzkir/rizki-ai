...
import { useStateSeo } from './lib/useStateSeo';
...
export default function Chat() {
    ...
    const quickPrompts = [
        { title: 'Keyword Research', prompt: 'Bagaimana cara melakukan keyword research?', icon: Compass },
        { title: 'On-Page SEO', prompt: 'Jelaskan on-page SEO dan best practices', icon: Compass },
        { title: 'Technical SEO', prompt: 'Apa itu technical SEO dan bagaimana mengoptimalkannya?', icon: Compass },
        { title: 'Link Building', prompt: 'Strategi link building yang efektif', icon: Compass },
    ];
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <p className="text-lg text-muted-foreground max-w-2xl">
                                                    Tanyakan apa saja tentang search engine optimization, keyword research, dan strategi SEO yang
                                                    relevan untuk websitemu.
                                                </p>
                                            </div>

                                            <div className="space-y-4">
                                                <AsideSectionDivider>Suggested SEO Actions</AsideSectionDivider>
